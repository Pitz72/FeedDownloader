...
- **Rilevamento Episodi "Ghost":** Gestione esplicita degli errori 404 (file rimossi dal server ma ancora nel feed) con report finale dei file mancanti.
...
- **Limitazione di Banda (Throttling):** Selettore per limitare i download paralleli (es. 1, 3, 5) e la velocità di trasferimento per non saturare la rete o attivare protezioni anti-bot.
- **Filtri Avanzati di Selezione:** Filtrare i download per intervallo di date, keyword nel titolo o durata dell'episodio.
...
- **Report di Salute (Health Check):** Dashboard con statistiche su ore totali archiviate, spazio occupato e integrità dei file su disco.
