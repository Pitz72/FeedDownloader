...
1.  Скачать файл установки `Runtime-FeedDownloader-Pro-Setup-1.3.0.exe` со страницы официальных релизов.
...
1.  Скачать файл `Runtime-FeedDownloader-Pro-1.3.0.dmg`.
...
1.  Скачать файл `Runtime-FeedDownloader-Pro-1.3.0.AppImage`.
2.  Сделать файл исполняемым. Доступные способы:
    ...
    *   **Через терминал:** `chmod +x Runtime-FeedDownloader-Pro-1.3.0.AppImage`
3.  Запустить файл двойным щелчком или из терминала: `./Runtime-FeedDownloader-Pro-1.3.0.AppImage`
...
*Примечание:* Перед обновлением до major-версии (например, с 1.2.x до 1.3.x) рекомендуется вручную скопировать файл `feeddownloader.db` в надёжное место.
