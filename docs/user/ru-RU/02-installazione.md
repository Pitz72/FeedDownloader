...
1.  Скачать файл установки `Runtime-FeedDownloader-Pro-Setup-0.7.5.exe` со страницы официальных релизов.
...
1.  Скачать файл `Runtime-FeedDownloader-Pro-0.7.5.dmg`.
...
1.  Скачать файл `Runtime-FeedDownloader-Pro-0.7.5.AppImage`.
2.  Сделать файл исполняемым. Доступные способы:
    ...
    *   **Через терминал:** `chmod +x Runtime-FeedDownloader-Pro-0.7.5.AppImage`
3.  Запустить файл двойным щелчком или из терминала: `./Runtime-FeedDownloader-Pro-0.7.5.AppImage`
