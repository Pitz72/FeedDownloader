...
1.  Scaricare il file di installazione `Runtime-FeedDownloader-Pro-Setup-1.3.0.exe` dalla pagina delle release ufficiale.
...
1.  Scaricare il file `Runtime-FeedDownloader-Pro-1.3.0.dmg`.
...
1.  Scaricare il file `Runtime-FeedDownloader-Pro-1.3.0.AppImage`.
2.  Rendere il file eseguibile. Le modalità disponibili sono:
    ...
    *   **Tramite terminale:** `chmod +x Runtime-FeedDownloader-Pro-1.3.0.AppImage`
3.  Avviare il file con un doppio clic oppure da terminale: `./Runtime-FeedDownloader-Pro-1.3.0.AppImage`
