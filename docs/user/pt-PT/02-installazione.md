...
1.  Transferir o ficheiro de instalação `Runtime-FeedDownloader-Pro-Setup-0.7.6.exe` a partir da página de lançamentos oficial.
...
1.  Transferir o ficheiro `Runtime-FeedDownloader-Pro-0.7.6.dmg`.
...
1.  Transferir o ficheiro `Runtime-FeedDownloader-Pro-0.7.6.AppImage`.
2.  Tornar o ficheiro executável. As opções disponíveis são:
    ...
    *   **Através do terminal:** `chmod +x Runtime-FeedDownloader-Pro-0.7.6.AppImage`
3.  Iniciar o ficheiro com um duplo clique ou a partir do terminal: `./Runtime-FeedDownloader-Pro-0.7.6.AppImage`
...
*Nota:* Antes de atualizar para uma versão major (por exemplo, de 0.7.x para 0.8.x), recomenda-se fazer uma cópia manual do ficheiro `feeddownloader.db` para um local seguro.
